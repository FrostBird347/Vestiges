	...
	public class PluginOptions : OptionInterface {
		...
		public override void Initialize() {
			...
			UIArrPlayerOptions = new UIelement[]
			{
				...
				new OpLabel(10f, 520f, "Vestige Limit"),
				new OpUpdown(VestigeLimit, new Vector2(110f, 520f), 75) { description = "Maximum number of Vestiges that can be placed in a single room" },
				new OpSimpleButton(new Vector2(10f, 490f), new Vector2(125f, 10f), "Reload Vestiges") { description = "Clear and redownload all Vestiges" },

				new OpLabel(10f, 430f, "Upload ID"),
				new OpTextBox(UploadID, new Vector2(200f,430f), 400f) { description = "Only change this if you know what you are doing!" },
				...
				new OpTextBox(EntryA, new Vector2(200f,370f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 340f, "entry2 ID"),
				new OpTextBox(EntryB, new Vector2(200f,340f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 310f, "entry3 ID"),
				new OpTextBox(EntryC, new Vector2(200f,310f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 280f, "entry4 ID"),
				new OpTextBox(EntryD, new Vector2(200f,280f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 250f, "entry5 ID"),
				new OpTextBox(EntryE, new Vector2(200f,250f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 220f, "entry6 ID"),
				new OpTextBox(EntryF, new Vector2(200f,220f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 190f, "entry7 ID"),
				new OpTextBox(EntryG, new Vector2(200f,190f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 160f, "entry8 ID"),
				new OpTextBox(EntryH, new Vector2(200f,160f), 400f) { description = "Only change this if you know what you are doing!" },
				new OpLabel(10f, 130f, "entry9 ID"),
				new OpTextBox(EntryI, new Vector2(200f,130f), 400f) { description = "Only change this if you know what you are doing!" }
			};
